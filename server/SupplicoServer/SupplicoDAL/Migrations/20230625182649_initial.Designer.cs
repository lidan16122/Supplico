...
namespace SupplicoDAL.Migrations
{
    ...
    [Migration("20230625182649_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SupplicoDAL.Order", b =>
                {
                    ...
                    b.Property<bool>("SupplierConfirmation")
                        .HasColumnType("bit");
                    ...
                    b.HasKey("OrderId")
                        .HasName("PK__Orders__C3905BCF2AF0F936");
                    ...
                    b.HasIndex(new[] { "TransactionId" }, "UQ__Orders__55433A4A7BB1E263")
                        .IsUnique()
            ...
            modelBuilder.Entity("SupplicoDAL.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("Id")
                        .HasName("PK__OrderIte__3214EC07BF992611");
            ...
            modelBuilder.Entity("SupplicoDAL.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Products__3214EC072E73F968");
            ...
            modelBuilder.Entity("SupplicoDAL.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SupplicoDAL.Order", b =>
                {
                    b.HasOne("SupplicoDAL.User", "Business")
                        .WithMany("OrderBusinesses")
                    ...
                    b.HasOne("SupplicoDAL.User", "Supplier")
                        ...
                        .HasConstraintName("FK__Orders__Supplier__44FF419A");
            ...
            modelBuilder.Entity("SupplicoDAL.OrderItem", b =>
                {
                    b.HasOne("SupplicoDAL.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .HasConstraintName("FK__OrderItem__Order__48CFD27E");

                    b.HasOne("SupplicoDAL.Product", "ProductNavigation")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("SupplicoDAL.Product", b =>
                {
                    b.HasOne("SupplicoDAL.User", "User")
                        .WithMany("Products")
